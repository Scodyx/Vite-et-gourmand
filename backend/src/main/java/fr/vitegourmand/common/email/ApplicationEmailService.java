...
public class ApplicationEmailService {
 ...
 public void cancellation(String to,String number){send(to,"Annulation de la commande "+number,"La commande "+number+" a été annulée.");}
 public void equipmentReturn(String to,String number){send(to,"Retour du matériel – "+number,"Merci de restituer le matériel sous 10 jours ouvrés. Des frais contractuels de 600 € sont prévus par les CGV en cas de non-retour.");}
 public void reviewInvitation(String to,String number){send(to,"Votre avis sur la commande "+number,"Votre prestation est terminée. Vous pouvez maintenant partager votre avis depuis votre espace.");}
 public void employeeCreated(String to,String firstName){send(to,"Votre compte employé Vite & Gourmand","Bonjour "+firstName+",\n\nVotre compte employé a été créé. Contactez l’administrateur pour recevoir votre mot de passe temporaire par un canal séparé.");}
 public void contactNotification(String replyTo,String title,String body){send(contactEmail,"Contact – "+title,"Répondre à : "+replyTo+"\n\n"+body);}
}
