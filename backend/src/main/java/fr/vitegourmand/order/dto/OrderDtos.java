...
public final class OrderDtos {
    ...
    public record Create(
            @NotNull Long menuId,
            @Min(1) int personCount,
            @NotNull @FutureOrPresent LocalDate prestationDate,
            @NotNull LocalTime desiredDeliveryTime,
            ...
            boolean equipmentLoaned) {}

    public record Transition(@NotNull OrderStatus status, String comment) {}

    public record Cancellation(
            @NotBlank String reason, @NotNull CancellationContactMode contactMode) {}
    ...
    public record View(
            ...
            String menuTitle,
            int personCount,
            LocalDate prestationDate,
            LocalTime desiredDeliveryTime,
            ...
            Instant createdAt) {
        public static View from(CustomerOrder o) {
            return new View(
                    o.getId(),
                    o.getOrderNumber(),
                    o.getMenu().getId(),
                    ...
                    o.getPersonCount(),
                    o.getPrestationDate(),
                    o.getDesiredDeliveryTime(),
                    o.getDeliveryAddress(),
                    o.getDeliveryPostalCode(),
                    o.getDeliveryCity(),
