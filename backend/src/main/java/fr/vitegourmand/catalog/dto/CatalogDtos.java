...
public final class CatalogDtos {
 ...
 public record DishView(Long id,String name,String description,DishType type,boolean active,List<AllergenView> allergens){}
 public record DishInput(@NotBlank @Size(max=160) String name,@Size(max=2000) String description,
  @NotNull DishType type,boolean active,Set<Long> allergenIds){}
