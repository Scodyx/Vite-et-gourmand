...
public class CatalogManagementService {
    ...
    public AllergenView createAllergen(AllergenInput request) {
        ...
        var allergen = new Allergen(); allergen.setName(request.name().trim());
    ...
    public AllergenView updateAllergen(Long id, AllergenInput request) {
        ...
        ensureUniqueAllergen(request.name(), id); allergen.setName(request.name().trim()); return view(allergen);
    }
    ...
    private void ensureUniqueAllergen(String name, Long id) {
        ...
        allergens.findAll().stream().filter(value -> normalize(value.getName()).equals(normalized)
                        && !value.getId().equals(id)).findAny()
